...
/// Admin Registrations List Screen with Provider-based state management
...
class SellerRegistrationsListScreen extends ConsumerWidget {
  const SellerRegistrationsListScreen({Key? key}) : super(key: key);
