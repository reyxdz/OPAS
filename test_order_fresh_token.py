#!/usr/bin/env python
"""Test the fixed order creation endpoint with fresh authentication"""
...
def test_order_endpoint_fresh():
    """Test order creation with fresh authentication"""
    print("=" * 80)
    print("Testing Order Endpoint with Fresh Token")
    print("=" * 80)
    
    # Create fresh token for buyer user (ID 43)
    import sys
    import os
    sys.path.insert(0, 'OPAS_Django')
    os.chdir('OPAS_Django')
